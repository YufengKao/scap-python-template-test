...
coverage: ## check code coverage quickly with the default Python
	coverage run --source iot_dss_user_profile_synchronizer -m pytest
	coverage report -m
	coverage html
	$(BROWSER) htmlcov/index.html

docs: ## generate Sphinx HTML documentation, including API docs
	rm -f docs/iot_dss_user_profile_synchronizer.md
	rm -f docs/modules.md
	sphinx-apidoc -o docs/ iot_dss_user_profile_synchronizer
	$(MAKE) -C docs clean
	$(MAKE) -C docs html
